...
const SerchHits: FC<Props> = ({ hits }) => {
  ...
  return (
    <>
      <div
        className="fixed top-0 left-0 z-20 h-screen w-screen bg-primary/10 backdrop-blur"
        onClick={toggleSearchModal}
      />
      <div className="container fixed top-0 left-1/2 z-20 mx-auto my-10 w-full max-w-6xl -translate-x-1/2 rounded-xl border border-base-content bg-base-100 px-10 py-10">
