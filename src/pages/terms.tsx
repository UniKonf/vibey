    ...
    <>
      ...
      <article className="prose mx-auto pt-28 dark:prose-invert">
        ...
        <p>
          ...
          use of Vibey's Website, located at https://www.vibey.live/.
        </p>

        <p>
          By accessing this website we assume you accept these terms and
          conditions. Do not continue to use Vibey if you do not agree to take
        ...
        <p>
          Unless otherwise stated, Vibey and/or its licensors own the
          intellectual property rights for all material on Vibey. All
          intellectual property rights are reserved. You may access this from
          Vibey for your own personal use subjected to restrictions set in these
        ...
        <p>
          ...
          Vibey does not filter, edit, publish or review Comments prior to their
          presence on the website. Comments do not reflect the views and
          opinions of Vibey,its agents and/or affiliates. Comments reflect the
          views and opinions of the person who post their views and opinions. To
          the extent permitted by applicable laws, Vibey shall not be liable for
        ...
        <p>
          ...
          sending an e-mail to Vibey. Please include your name, your
