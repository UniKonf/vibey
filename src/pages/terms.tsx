...
export default function Terms() {
  return (
    <article className="prose  prose-invert mx-auto">
      ...
      <p>Welcome to Vibey!</p>

      <p>
        These terms and conditions outline the rules and regulations for the use
        of Vibey's Website, located at https://www.vibey.live/.
      </p>

      <p>
        By accessing this website we assume you accept these terms and
        conditions. Do not continue to use Vibey if you do not agree to take all
      ...
      <p>
        We employ the use of cookies. By accessing Vibey, you agreed to use
        cookies in agreement with the Vibey's Privacy Policy.{' '}
      </p>
      ...
      <p>
        Unless otherwise stated, Vibey and/or its licensors own the intellectual
        property rights for all material on Vibey. All intellectual property
        rights are reserved. You may access this from Vibey for your own
      ...
      <p>You must not:</p>
      <ul>
        <li>Republish material from Vibey</li>
        <li>Sell, rent or sub-license material from Vibey</li>
        <li>Reproduce, duplicate or copy material from Vibey</li>
        <li>Redistribute content from Vibey</li>
      </ul>
      ...
      <p>
        ...
        exchange opinions and information in certain areas of the website. Vibey
        ...
        of Vibey,its agents and/or affiliates. Comments reflect the views and
        opinions of the person who post their views and opinions. To the extent
        permitted by applicable laws, Vibey shall not be liable for the Comments
      ...
      <p>
        Vibey reserves the right to monitor all Comments and to remove any
      ...
      <p>
        You hereby grant Vibey a non-exclusive license to use, reproduce, edit
      ...
      <p>
        ...
        the hyperlink compensates the absence of Vibey; and (d) the link is in
      ...
      <p>
        ...
        e-mail to Vibey. Please include your name, your organization name,
      ...
      <p>
        No use of Vibey's logo or other artwork will be allowed for linking
