...
export default function PrivacyPolicy() {
  return (
    <article className="prose mx-auto pt-28 dark:prose-invert">
      ...
      <p>
        At Vibey, accessible from https://www.vibey.live/, one of our main
        priorities is the privacy of our visitors. This Privacy Policy document
        contains types of information that is collected and recorded by Vibey
        and how we use it.
      </p>
      ...
      <p>
        ...
        shared and/or collect in Vibey. This policy is not applicable to any
      ...
      <p>
        Vibey follows a standard procedure of using log files. These files log
      ...
      <p>
        ...
        advertising partners of Vibey.
      </p>

      <p>
        Third-party ad servers or ad networks uses technologies like cookies,
        JavaScript, or Web Beacons that are used in their respective
        advertisements and links that appear on Vibey, which are sent directly
      ...
      <p>
        Note that Vibey has no access to or control over these cookies that are
      ...
      <p>
        Vibey's Privacy Policy does not apply to other advertisers or websites.
      ...
      <p>
        Vibey does not knowingly collect any Personal Identifiable Information
